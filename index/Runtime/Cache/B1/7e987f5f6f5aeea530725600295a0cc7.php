        ...
        <center>
            ...
            <form method="post" action="__URL__/update">
                ...
                <table>
                    ...
                    <tr>
                        <td>头衔</td>
                        <td><input type="text" name="title" value="<?php echo ($info['title']); ?>"></input></td>
                    </tr>
                    <tr>
                        <td>电话</td>
                    ...
                    <tr>
                        <td>邮箱</td>
                        <td><input type="text" name="email" value="<?php echo ($info['email']); ?>"></input></td>
                    </tr>
                    <tr>
                        <td>个人简介</td>
                        <td><input type="text" name="description" rows="10" cols="30" value="<?php echo ($info['description']); ?>"></input></td>
                    </tr>
                    <tr>
            ...
            <a href="__URL__/course/id/<?php echo ($info['id']); ?>">我的课程</a>
        </center>
